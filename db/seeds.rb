...
User.create!(email: 'joe@example.com', first_name: 'Joe', last_name: 'Biden', password:  "password2", role: :default)
User.create!(email: 'hillary@example.com', first_name: 'Hillary', last_name: 'Clinton', password:  "password3", role: :default)
